...
style="background-image:url('img/pattern_peq_bn.png'); background-attachment: fixed;">
	...
	<!-- eldisplay original estaba en none habría que verificar en el js que el display quede como flex-->
	<div style="height:100%; text-align: center; display: flex; flex-direction:column; justify-content: space-between; "
	id="formulario" >
		...
		<form id="formularioForm" action="EvaluacionIntensidadesServlet?metodo=procesarDatosWebInf" method="post">
			...
			padding: 10px 10px 10px 10px; display:flex; justify-content: space-between; align-items: center;" >
				...
				<p style="font-weight: bold; font-size: 28px;">Reporta el sismodddddd</p>
			...
			<fieldset>
				...
				<br/>Si el sismo no está en la lista, <a href="#" onclick="mostrarSismoManual(); validarIdSismo([]);">haz clic aquí.</a>
			...
			<fieldset>
				...
				--%>
				<label></label>
				<button onclick="geolocalizar()" id="btnGeolocalizar" type="button" style="padding:5px 10px 5px 10px; margin-bottom: 10px; background-color:  #1a4480; color:#fff; display: inline-flex; 
				align-items: center;">				
			...
			<fieldset>			
				...
				<div id="dependientesAdentroEdificio" style="display: block;">
					...
					<select id="piso" name="piso" title="Piso en el que te encontrabas" onchange="validarPiso([])">
			...
			<fieldset>
				...
				<br>
				<div style="padding-left: var(--ancho_label);"> 
				...
				<div id="dependientesDano" style="display: none;">
					...
					<br>
					<label>Tipo de da&ntilde;o</label><br>
