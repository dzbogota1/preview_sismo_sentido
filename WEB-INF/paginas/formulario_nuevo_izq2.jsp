...
<head>
	...
	<style>
		...
		.panelPreguntas {
			display:grid;
			gap: 10px 1px;
			grid-template-columns: <%--500px--%> 40vw auto;
...
style="background-image:url('img/pattern_peq_bn.png'); background-attachment: fixed; position:relative; z-index:0; width: 100vw; ">
	...
	style="background-color: rgba(255, 255, 255, 0.5); margin:0 50px 0 50px; position:relative; z-index:1;" >
		...
		<fieldset class="panelPreguntas">			
			...
			<span>
				...
				<label class="labelRadioButton">Dentro de una edificaci&oacute;n</label>								
		...
		<fieldset class ="panelOtrosEfectos">
			<legend style="width: auto;">Otros efectos</legend>
			
			<label style="width:100%;">&iquest;Hubo alg&uacute;n efecto sobre la naturaleza
				cerca de donde estabas?
			</label>
			
			<textarea rows="4" cols="50"  name="efectos_naturaleza" maxlength="500" style="margin-bottom: 10px;"
			 placeholder="Por ejemplo: deslizamientos de tierra, grietas en el suelo, cambios en el curso de r&iacute;os, etc. "></textarea>								
			
			<label style="width:100%; padding-top:100px; position:relative;">&iquest;Alg&uacute;n comentario adicional sobre el sismo
				que resulte &uacute;til?
			</label>
			
			<textarea rows="4" cols="50" name="comentarios" maxlength="500"   
			style="margin-bottom: 10px;" placeholder="Por ejemplo: duración, ruido, dirección del movimiento, etc."></textarea>
